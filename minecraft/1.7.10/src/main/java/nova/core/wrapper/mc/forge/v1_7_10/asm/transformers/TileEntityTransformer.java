...
public class TileEntityTransformer implements Transformer {
	...
	public void transform(ClassNode cnode) {
		...
		list.add(new MethodInsnNode(INVOKESTATIC, "nova/core/wrapper/mc/forge/v_1_7_10/asm/StaticForwarder", "loadTileEntityHook", "(Lnet/minecraft/nbt/NBTTagCompound;Ljava/lang/Class;)Lnet/minecraft/tileentity/TileEntity;", false));
