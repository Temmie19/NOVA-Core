...
public class ChunkTransformer implements Transformer {
	...
	public void transform(ClassNode cnode) {
		...
		list.add(new MethodInsnNode(INVOKESTATIC, "nova/core/wrapper/mc/forge/v_1_7_10/asm/StaticForwarder", "chunkSetBlockEvent", "(Lnet/minecraft/world/chunk/Chunk;IIILnet/minecraft/block/Block;ILnet/minecraft/block/Block;I)V", false));
